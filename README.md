...
| 88 | Darkmoon | https://github.com/ASCIT31/Dark-Moon | GitHub | 2026-06 | Open-source autonomous AI pentesting platform and MCP host with per-technology offensive sub-agents (GraphQL, Spring, .NET, Node, PHP, Ruby, WordPress), Active Directory and Kubernetes, and an evidence trail per finding; orchestrates 80+ offensive tools via MCP. |  |  |
